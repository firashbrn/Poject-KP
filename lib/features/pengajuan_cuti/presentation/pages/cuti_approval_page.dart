...
class CutiApprovalPage extends CleanView {
  const CutiApprovalPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _CutiApprovalPageState();
}

class _CutiApprovalPageState extends CleanViewState<CutiApprovalPage, CutiController> {
  _CutiApprovalPageState() : super(sl<CutiController>());
  ...
  Widget get view {
    return ControlledWidgetBuilder<CutiController>(
      builder: (context, controller) {
        ...
        return Scaffold(
          appBar: AppBar(title: const Text('Verifikasi Cuti Bawahan')),
  ...
  void _showRejectDialog(BuildContext context, CutiController controller, Cuti item) {
